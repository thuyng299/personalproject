...
public interface IncomingDetailAPI {
    ...
    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/product-incoming") // localhost:8080/incomingdetails/product-incoming?date=2024-02-27
    ...
    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/incoming-purchasetime-amount") // localhost:8080/incomingdetails/incoming-purchasetime-amount
    ResponseEntity<List<PurchaseTimeStatDTO>> getNumberOfPurchaseTimeAndAmount();

    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/product-purchasetime-amount") // localhost:8080/incomingdetails/product-purchasetime-amount?inputId=30
    ResponseEntity<PurchaseTimeStatDTO> getPurchaseTimeAndAmountOfSpecificProduct(@RequestParam("inputId") Long inputId);

    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/inputproduct-purchasetime-amount") // localhost:8080/incomingdetails/inputproduct-purchasetime-amount?inputId=15&inputDate=2022-08-27
    ...
    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/purchaseamount-fromdate-todate") // localhost:8080/incomingdetails/purchaseamount-fromdate-todate?fromDate=2022-01-21&toDate=2022-07-21
    ...
    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/stock-nearlyexpiring") // localhost:8080/incomingdetails/stock-nearlyexpiring?inputCountDays=30
    ...
    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/totalstock-rawmaterial-fromdate-todate") // localhost:8080/incomingdetails/totalstock-rawmaterial-fromdate-todate?inputDate=2022-07-21
    ...
    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/totalstock-finishedgood-fromdate-todate") // localhost:8080/incomingdetails/totalstock-finishedgood-fromdate-todate?inputDate=2022-07-21
    ...
    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
    @GetMapping("/totalproductcost") // localhost:8080/incomingdetails/totalproductcost
