...
//
//    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
//    @GetMapping("/salesamount-fromdate-todate") // localhost:8080/outcomingsdetails/salesamountbetweendates?fromDate=2023-01-03&toDate=2023-01-19
...
//
//    @PreAuthorize("hasAnyRole('USER', 'WAREHOUSE_STAFF')")
//    @GetMapping("/top5-customers") // localhost:8080/outcomingsdetails/top5customers?inputYear=2023
